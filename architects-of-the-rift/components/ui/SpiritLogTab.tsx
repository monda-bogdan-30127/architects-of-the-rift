...
const REASON_LABEL: Record<SpiritReason, string> = {
  ...
  close_loss_cushion:      "Close loss — fought hard",
  high_score:              "Strong scores",
  low_score:               "Weak scores",
  game_mvp:                "Game MVP",
  series_mvp:              "Series MVP",
  mvp_loss_cushion:        "Carried in a loss",
  ...
  underperform_signature:  "Slumped on signature",
  overperform_off_comfort: "Excelled off-comfort",
  carried_alone_lost:      "Carried alone, lost",
