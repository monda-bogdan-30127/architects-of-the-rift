...
const toDisplayStyleLabel = (style?: Player["playstyleIdentity"] extends { secondary: infer T } ? T : string) => {
  switch (style) {
    case "carry":
      return "Carry";
    case "utility":
  ...
  switch (role) {
    case "top": {
      ...
      tagCandidates = [
        ...
        { label: "Scaling", score: scalingOrientation * 0.62 + teamfighting * 0.24 + consistency * 0.14 },
        { label: "Teamfight", score: teamfighting * 0.58 + scalingOrientation * 0.14 + clutchFactor * 0.16 + consistency * 0.12 },
